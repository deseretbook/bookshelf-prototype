...
(function () {
  ...
  const CAT_NAMES = { "all-categories": "Browse All Categories", clearance: "Summer Clearance" };
  ...
  window.DB_DATA = {
    ...
    inCat: (id) => (id === "new-trending" ? P.slice() : id === "clearance" ? P.filter((p, i) => i % 2 === 0) : P.filter((p) => p.cat === id || p.cat.indexOf(id) === 0)),
