...
(function () {
  ...
  const P = [
    { id: "6095538", t: "Seeking Persephone (Movie Tie-in Edition)", by: "Eden, Sarah M.", price: 18.99, r: 4.5, rc: 214, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P5068623", t: "Seeking Persephone (The Lancaster Family, Book 1)", by: "Eden, Sarah M.", price: 11.99, priceHigh: 17.99, r: 4.5, rc: 386, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P5043081", t: "Courting Miss Lancaster (The Lancaster Family, Book 2)", by: "Eden, Sarah M.", price: 11.99, priceHigh: 15.99, r: 4.5, rc: 241, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P5183500", t: "Romancing Daphne (The Lancaster Family, Book 3)", by: "Eden, Sarah M.", price: 9.99, priceHigh: 17.99, r: 4.5, rc: 178, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P5197705", t: "Loving Lieutenant Lancaster (The Lancaster Family, Book 4)", by: "Eden, Sarah M.", price: 9.99, priceHigh: 16.99, r: 4.5, rc: 143, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P5258117", t: "Charming Artemis (The Lancaster Family, Book 5)", by: "Eden, Sarah M.", price: 9.99, priceHigh: 18.99, r: 4.5, rc: 132, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "PR00001380", t: "Every Beat After", by: "Various", price: 18.99, priceHigh: 32.99, r: 5, rc: 27, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "PR00001397", t: "The Duke\u2019s Bargain", by: "Various", price: 18.99, priceHigh: 32.99, r: 4.5, rc: 31, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P6001424", t: "Lily of the Valley (The Gents, Book 2)", by: "Eden, Sarah M.", price: 9.99, priceHigh: 17.99, r: 4.5, rc: 84, cat: "books_fiction_romance", fmt: "Paperback",
      img: [I("27/45/0b/6a/6a0b4527ad820a67a64ae936/" + dbl("6001424_HERO_LILY-OF-THE-VALLEY_PAPERBACK.jpg"))],
      d: "Book two of the Gents." },
    { id: "P6087437", t: "Love in a Mist (The Gents, Book 5)", by: "Eden, Sarah M.", price: 17.99, priceHigh: 19.99, r: 5, rc: 44, cat: "books_fiction_romance", fmt: "Paperback",
      img: [I("80/02/0e/6a/6a0e02809a628cfe734712de/" + dbl("6087437_HERO_LOVE-IN-A-MIST_PAPERBACK.jpg"))],
      d: "Book five of the Gents." },
    { id: "P5226193", t: "The Heart of a Vicar (The Jonquil Brothers, Book 6)", by: "Eden, Sarah M.", price: 11.99, priceHigh: 17.99, r: 4.5, rc: 118, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P5076966", t: "Friends and Foes (The Jonquil Brothers, Book 1)", by: "Eden, Sarah M.", price: 9.99, priceHigh: 15.99, r: 4.5, rc: 165, cat: "books_fiction_romance", fmt: "Paperback",
      img: [I("01/28/d9/69/69d9280125a976d06b27952a/" + dbl("5076966_HERO_FRIENDS-AND-FOES.jpg"))],
      d: "Where the Jonquil Brothers begin." },
    { id: "P5117030", t: "As You Are (The Jonquil Brothers, Book 3)", by: "Eden, Sarah M.", price: 9.99, priceHigh: 17.99, r: 4.5, rc: 121, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P6027265", t: "Christmas at Falstone Castle", by: "Eden, Sarah M.", price: 3.99, priceHigh: 7.99, r: 4.5, rc: 73, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P5127561", t: "For Elise", by: "Eden, Sarah M.", price: 9.99, priceHigh: 17.99, r: 4.5, rc: 88, cat: "books_fiction_romance", fmt: "Paperback",
    ...
    { id: "P6096125", t: "Quad Combination Simulated Leather, Regular, Indexed (Limited Edition Color)", by: "Deseret Book", price: 79, r: 4.6, rc: 58, cat: "church-resources_scriptures_scripture-essentials", fmt: "Faux-Leather", size: "5.25\" x 7.25\"", online: true,
      colors: [
    ...
    { id: "P6074927", t: "Simulated Leather Quad Combination, Regular (Color Options)", by: "Deseret Book", price: 79, r: 4.5, rc: 402, cat: "church-resources_scriptures_scripture-essentials", fmt: "Faux-Leather", size: "5.25\" x 7.25\"",
    ...
    { id: "P6079208", t: "Simulated Leather Triple Combination, Regular (Color Options)", by: "Deseret Book", price: 45, r: 4.5, rc: 236, cat: "church-resources_scriptures_scripture-essentials", fmt: "Faux-Leather",
      colors: [{ n: "Dusty Rose", sw: "#c39ba0" }, { n: "Pacific Blue", sw: "#4d6f8c" }, { n: "Forest Green", sw: "#3f5a45" }, { n: "Walnut Brown", sw: "#7b5b42" }],
    ...
    { id: "P6079204", t: "Simulated Leather Holy Bible, Regular (Color Options)", by: "Deseret Book", price: 55, r: 4.5, rc: 194, cat: "church-resources_scriptures_scripture-essentials", fmt: "Faux-Leather",
      colors: [{ n: "Dusty Rose", sw: "#c39ba0" }, { n: "Pacific Blue", sw: "#4d6f8c" }, { n: "Forest Green", sw: "#3f5a45" }, { n: "Walnut Brown", sw: "#7b5b42" }],
    ...
    { id: "5111165", t: "Quad Combination, Simulated Leather, Regular, Indexed", by: "Church Distribution", price: 56, r: 4.5, rc: 511, cat: "church-resources_scriptures_scripture-essentials", fmt: "Faux-Leather",
    ...
    { id: "P6088525", t: "Simulated Leather Quad Combination, Compact (Color Options)", by: "Deseret Book", price: 59, r: 4.5, rc: 87, cat: "church-resources_scriptures_scripture-essentials", fmt: "Faux-Leather",
    ...
    { id: "5111190", t: "Quad Combination, Genuine Leather, Regular Indexed", by: "Church Distribution", price: 66, r: 4.5, rc: 121, cat: "church-resources_scriptures_genuine-leather-scriptures", fmt: "Genuine Leather",
    ...
    { id: "5111199", t: "Holy Bible, Genuine Leather, Regular, Indexed", by: "Church Distribution", price: 55, r: 4.5, rc: 143, cat: "church-resources_scriptures_genuine-leather-scriptures", fmt: "Genuine Leather",
    ...
    { id: "5034651", t: "Book of Mormon, Regular, Blue", by: "Church Distribution", price: 4.5, r: 5, rc: 902, cat: "church-resources_scriptures_scripture-essentials", fmt: "Softcover",
    ...
    { id: "5130963", t: "Pocket-size Scripture Set", by: "Church Distribution", price: 17.5, r: 4.5, rc: 208, cat: "church-resources_scriptures_scripture-essentials", fmt: "Softcover",
    ...
    { id: "6020732", t: "The Book of Mormon, Journal Edition, Aqua Floral (No Index)", by: "Deseret Book", price: 24.99, r: 4.5, rc: 164, cat: "church-resources_scriptures_scripture-journal-editions", fmt: "Hardcover",
    ...
    { id: "5034652", t: "The Book of Mormon, Regular Paperback", by: "Church Distribution", price: 4, r: 5, rc: 640, cat: "church-resources_scriptures_scripture-essentials", fmt: "Paperback",
    ...
    { id: "P6026445", t: "Regular Scripture Tote Backpack", by: "Wings Bags", price: 29.99, priceHigh: 39.99, r: 4.5, rc: 96, cat: "church-resources_scriptures_scripture-totes", fmt: "Tote",
    ...
    { id: "PR00001434", t: "Enoch Large Scripture Tote", by: "Wings Bags", price: 29.99, r: 4.5, rc: 41, cat: "church-resources_scriptures_scripture-totes", fmt: "Tote",
    ...
    { id: "P6087552", t: "Regular Bow Scripture Tote", by: "Wings Bags", price: 27.99, r: 5, rc: 34, cat: "church-resources_scriptures_scripture-totes", fmt: "Tote",
    ...
    { id: "P6085110", t: "Double Zipper with Strap Regular Scripture Tote", by: "Wings Bags", price: 37.99, priceHigh: 39.99, r: 4.5, rc: 58, cat: "church-resources_scriptures_scripture-totes", fmt: "Tote",
    ...
    { id: "6021463", t: "Blue on Blue Regular Scripture Tote", by: "Wings Bags", price: 16.99, r: 4, rc: 27, cat: "church-resources_scriptures_scripture-totes", fmt: "Tote",
  ...
  const CAT_NAMES = { "all-categories": "Browse All Categories" };
  ...
  window.DB_DATA = {
    ...
    inCat: (id) => P.filter((p) => p.cat === id || p.cat.indexOf(id) === 0),
    trending: ["6095538", "P5043081", "P6096125", "P6074927", "P6079204", "P6079208"],
    featuredCats: [
    ...
    featuredContent: [
      { label: "Scripture of the Week", kicker: "STUDY", pid: "P6096125" },
      { label: "Three New Titles for the Quiet Hours", kicker: "BLOG POST", pid: "6095538" },
      { label: "Choosing a Set of Scriptures", kicker: "GUIDE", pid: "P6074927" },
      { label: "Totes for the Family Shelf", kicker: "PROMO", pid: "P6026445" },
      { label: "Reading the Old Testament Slowly", kicker: "BLOG POST", pid: "5230632" }
    ],
